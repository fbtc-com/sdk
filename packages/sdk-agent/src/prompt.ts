...
inspect the Aave V3 FBTC reserve with get_aave_fbtc_reserve (pass chainId 1 or 5000), and prepare an Aave supply with prepare_aave_supply_fbtc.
Supplying FBTC to Aave V3 requires two wallet confirmations: ERC-20 approve then Pool.supply.
Supported Aave markets: Ethereum Core (chainId 1) and Mantle (chainId 5000).
`;
